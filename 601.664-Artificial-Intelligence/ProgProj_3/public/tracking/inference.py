...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for posi in self.allPositions:
            self.beliefs[posi] = self.getObservationProb(observation, gameState.getPacmanPosition(), posi,
                                                         self.getJailPosition()) * self.beliefs[posi]
        self.beliefs.normalize()
...
class ParticleFilter(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for part in self.particles:
            self.beliefs[part] += self.getObservationProb(observation, gameState.getPacmanPosition(), part,
...
class JointParticleFilter(ParticleFilter):
    ...
    def initializeUniformly(self, gameState):
        ...
        while index < n:
            if n - index < size:
                self.particles += permutations[0:n - index]
                return
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for part in self.particles:
            ...
            for i in range(self.numGhosts):
                prob *= self.getObservationProb(observation[i], gameState.getPacmanPosition(), part[i],
